...
BUYER_QUERY_TEMPLATES = [
    'site:facebook.com/groups ("need someone" OR "looking for someone") ("concrete" OR "driveway" OR "patio")',
    'site:facebook.com/groups ("recommend" OR "recommendation") ("concrete contractor" OR "concrete guy")',
    'site:facebook.com/groups ("who can" OR "anyone know") ("pour concrete" OR "do concrete" OR "concrete work")',
    'site:facebook.com/groups ("need a quote" OR "need estimate" OR "getting quotes") ("concrete" OR "driveway" OR "patio")',
    'site:facebook.com/groups ("my driveway" OR "our driveway") ("replace" OR "extend" OR "repair" OR "pour")',
    'site:facebook.com/groups ("my patio" OR "our patio") ("extend" OR "replace" OR "pour" OR "add concrete")',
    'site:facebook.com/groups ("ready to pour" OR "need poured" OR "needs to be poured") concrete',
    'site:facebook.com/groups ("contractor backed out" OR "contractor ghosted" OR "need another contractor") concrete',
]
