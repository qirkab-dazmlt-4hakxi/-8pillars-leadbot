...
BUYER_QUERY_TEMPLATES = [
    '("need someone" OR "looking for someone" OR "who can" OR "anyone know") concrete driveway patio slab {city} Texas',
    '("recommend" OR "recommendation" OR "looking for recommendations") concrete driveway patio contractor {city} Texas',
    '("need quote" OR "need estimate" OR "getting estimates" OR "price this") concrete driveway patio slab {city} Texas',
    '("my driveway" OR "our driveway" OR "my patio" OR "our patio") concrete replace extend repair pour {city} Texas',
    '("contractor backed out" OR "contractor ghosted" OR "need another contractor" OR "ready to pour") concrete {city} Texas',
    '("concrete sub needed" OR "concrete crew needed" OR "foundation crew" OR "looking for subs") {city} Texas',
]
