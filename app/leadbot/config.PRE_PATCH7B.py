...
BUYER_QUERY_TEMPLATES = [
    'site:facebook.com/groups ("need someone" OR "looking for someone" OR "who can" OR "anyone know") ("pour concrete" OR "concrete work" OR "concrete contractor" OR driveway OR patio)',
    'site:facebook.com/groups ("need a quote" OR "need estimate" OR "getting quotes" OR "looking for estimates") (concrete OR driveway OR patio OR slab)',
    'site:facebook.com/groups ("my driveway" OR "our driveway" OR "my patio" OR "our patio") ("replace" OR "extend" OR "repair" OR "pour" OR "add concrete")',
    'site:facebook.com/groups ("ready to pour" OR "need poured" OR "contractor backed out" OR "contractor ghosted" OR "need another contractor") concrete',
]
